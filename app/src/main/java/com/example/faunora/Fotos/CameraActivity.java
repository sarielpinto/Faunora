...
package com.example.faunora.Fotos;
...
import com.example.faunora.Fotos.env.ImageUtils;
import com.example.faunora.Fotos.env.Logger;
import com.example.faunora.Fotos.tflite.Classifier;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private Classifier.Model model = Classifier.Model.FAUNA;
  ...
  protected void showResultsInBottomSheet(List<Classifier.Recognition> results) {
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        ...
        if(recognitionValueTextView.equals("Girasol")) {
          Toast.makeText(getApplicationContext(), "holaBb", Toast.LENGTH_SHORT).show();
        }
      }
