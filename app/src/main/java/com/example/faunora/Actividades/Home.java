...
public class Home extends AppCompatActivity
    ...
    private void iniPopup() {
        ...
        popAddPost.setContentView(R.layout.popup_add_post2);
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!popupTitle.getText().toString().isEmpty()
                    ...
                    showMessage("\n" +
                            "verifique todos los campos de entrada y elija Publicar imagen") ;
                    popupAddBtn.setVisibility(View.VISIBLE);
                    popupClickProgress.setVisibility(View.INVISIBLE);
    ...
    private void addPost(Post post) {
        ...
        myRef.setValue(post).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                showMessage("Publicación agregada correctamente");
                popupClickProgress.setVisibility(View.INVISIBLE);
                popupAddBtn.setVisibility(View.VISIBLE);
                popAddPost.dismiss();
            }
    ...
    public void updateNavHeader() {
        ...
        ImageView navUserPhot = headerView.findViewById(R.id.nav_userphoto);
